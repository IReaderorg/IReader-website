        ...
        <div className="flex flex-col gap-8">
          <section className="flex flex-col gap-4">
            <header className="flex flex-col gap-1">
              ...
              <p className="text-xs text-[color-mix(in_srgb,_var(--color-foreground)_60%,_transparent)]">
                Tap an extension to copy its name. Use the repository link below to
                reinstall them in IReader.
              </p>
            </header>
          ...
          <section className="flex flex-col gap-3">
            <header className="flex flex-col gap-1">
              ...
              <p className="text-xs text-[color-mix(in_srgb,_var(--color-foreground)_60%,_transparent)]">
                Add the official extension repository back into IReader.
              </p>
            </header>

            <a
              href={`ireader://repo/add?url=${encodeURIComponent(
                pluginsSourceUrl
              )}`}
